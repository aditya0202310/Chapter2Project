...
public class Line {
    private Point end1; //Instance Variables
    private Point end2;
    ...
    {
       double d = Math.sqrt(Math.pow ((end2.getX() - end1.getX()), 2) + Math.pow(end2.getY() - end1.getY(),2)); //You may find Math.pow(base, power) and Math.sqrt(num) useful
        return d;
    }
    public Point midpoint()
    {
        double x = (end2.getX() + end1.getX())/2;
        double y = (end2.getY() + end1.getY())/2;
